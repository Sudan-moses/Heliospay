...
export function ReceiptPrint({ payment, student, branding }: { payment: any, student: any, branding?: BrandingParam }) {
        ...
        <div className="flex justify-between items-start border-b-2 border-slate-100 pb-8 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              {schoolAddress && <p className="text-slate-500 text-sm">{schoolAddress}</p>}
